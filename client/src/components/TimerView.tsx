...
export function TimerView({
  ...
  return (
    <div className="mx-auto w-full max-w-md rounded-[2rem] border border-tempo-border/20 bg-tempo-surface/70 shadow-[0_12px_40px_rgba(15,23,42,0.18)]">
      <div className="flex flex-col items-center text-center pt-10 pb-8 px-4">
        ...
        <div className="relative flex items-center justify-center" style={{ width: 220, height: 220 }}>
          ...
          <div
            ...
            style={{
              fontSize: '3.5rem',
              letterSpacing: '-1.5px',
              color: isRunning ? 'rgb(var(--tempo-text))' : 'rgb(var(--tempo-muted))',
        ...
        <div className="h-8 flex items-center mt-5">
          {isRunning && (
            <div
              className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-tempo-surface/85 text-xs font-medium transition-all duration-500"
